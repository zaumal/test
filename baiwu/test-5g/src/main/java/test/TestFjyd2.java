...
public class TestFjyd2 {
	...
	protected String address = "+8615132291613";
	protected String TEL_URI = "tel:"+address;
	...
	public TestFjyd2(String cspToken,String cspId,String chatbotId) {
...
//		this.cspToken = cspToken;
	...
	public static void main(String[] args) {
		...
		TestFjyd2 t = new TestFjyd2(cspToken,cspId,chatbotId);
...
//		System.out.println(authorization.equals("Basic dGVzdDEyMzQ1OmI3MzEzNzgwYTU5ZDg2OTRlMzU0NGFlZGM2ZmNhNjA0MjIwM2ZlMDBmNWVmNmYyOTI5YjYwOWJjZThkYjIzYzU="));
	...
	String sendText() {
		...
		return request(new Request.Builder()
				...
				.addHeader("Address",this.address)
